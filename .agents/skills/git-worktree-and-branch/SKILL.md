...
# git-worktree-and-branch (pinned wrapper)

Follow the full pinned skill at [../../../.agent-project-ops/skills/git-worktree-and-branch/SKILL.md](../../../.agent-project-ops/skills/git-worktree-and-branch/SKILL.md).
